...
Soon another branch will be added to access to	data based on the high-coverage WGS Illumina data from 3,202 1000 Genomes Project (1kGP) samples, described in Byrska-Bishop et al., 2022 (PMID: 36055201). Especicially the 	data	associated	with	the	[1000	Genomes	resequencing	done	at	New	York	Genome	Center](https://ftp.1000genomes.ebi.ac.uk/vol1/ftp/data_collections/1000G_2504_high_coverage/working/20190425_NYGC_GATK). directory of their ftp site.
