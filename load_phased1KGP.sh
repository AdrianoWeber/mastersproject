...
## This version of the script access the directory containing the high-coverage phased WGS panel consisting of high-quality SNV and INDEL calls across 3,202 1kGP samples.
...
OUTPUT_DIR=.
VCF_DIR="./1KGP_vcf_files"

#URL of the compressed vcf files and index.
...
do
  ...
  #Remove data if keep option not provided
  if [[ $keep -eq 0 ]]; then
